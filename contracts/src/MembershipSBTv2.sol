    ...
    UUPSUpgradeable
{
    ...
    mapping(uint256 => uint256) public lastClaimedEpoch; // NEW in v2
    ...
    function initializeV2(address revoker) external reinitializer(2) {
    ...
    /// @notice Admin revoke. Burns the SBT.
    ...
    function markClaimed(uint256 tokenId, uint256 epoch) external {
        // NB: only the rewards distributor should call this — see Findings.
